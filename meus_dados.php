												...
												<div class="col-md-6">
													...
													<div class="form-group">
														...
														<input id="celular" type="tel"
															...
															placeholder="(00) 00000-0000" required autofocus readonly>
														<div class="invalid-feedback">
															Celular válido
														</div>
													</div>
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														...
														<input id="cep" type="text"
															...
															class="form-control" name="cep" required autofocus readonly>
														<div class="invalid-feedback">
															CEP válido
														</div>
													</div>
													<div class="form-group">
														...
														<input id="rua" type="text"
															...
															class="form-control" name="rua" required autofocus readonly>
														<div class="invalid-feedback">
															Rua válida
														</div>
													</div>
