				...
				<div class="container h-100">
					<div class="row justify-content-md-center h-100">
						<div class="card-wrapper">
							...
							<div class="card fat">
								<div class="card-body">
								<form  method="POST" action="php/proc_cad_cliente.php" enctype="multipart/form-data" class="my-login-validation" >
									<?php
									...
									<h1 style="font-weight: 600;">Cadastro</h1><br>
										...
										<div class="form-row">
											...
											<div class="form-group col-md-5">
													...
													<input required type="text" name="bairro" id="bairro"  placeholder="Bairro" class="form-control" autofocus>	
													<div class="invalid-feedback">
													Bairro válido
													</div>
												</div>
